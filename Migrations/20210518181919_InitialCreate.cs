    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArticleTags", x => new { x.ArticleId, x.TopicId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArticleTags_Topics_TopicId",
                        column: x => x.TopicId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFieldOfInterests", x => new { x.UserId, x.TopicId });
                    table.ForeignKey(
                        name: "FK_UserFieldOfInterests_Topics_TopicId",
                        column: x => x.TopicId,
                        principalTable: "Topics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkExperiences_Topics_TopicId",
                        column: x => x.TopicId,
                        principalTable: "Topics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFieldOfInterests_TopicId",
                table: "UserFieldOfInterests",
                column: "TopicId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkExperiences_TopicId",
                table: "WorkExperiences",
                column: "TopicId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkExperiences_UserId_CompanyName_TopicId_StartYear",
                table: "WorkExperiences",
                columns: new[] { "UserId", "CompanyName", "TopicId", "StartYear" },
                unique: true);
        }
